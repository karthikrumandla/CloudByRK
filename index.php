...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    <div id="ConVox-Container" class="container-fluid">
    </div>
    <nav id="MyFooter" class="fixed-bottom text-center">
      
        
          <small>
            © 2020 by - <a target="_blank" rel="noopener noreferrer" href="https://convoxcloud.com">
              ConVox Cloud
            </a>
          </small>
